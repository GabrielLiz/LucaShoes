...
<body>
	...
	<div
		class="u-header__section u-header__section--dark g-bg-black-opacity-0_7 g-transition-0_3 g-py-10"
		...
		<div class="container">
			...
			<!-- Logo -->
			<a href="#" class="text-warning fontluca g-mr-15">LucaShoes</a>
			<!-- End Logo -->
			...
			<div
				...
				<ul id="js-scroll-nav"
					...
					<li class="nav-item g-mx-20--lg active"><a href="#home"
						class="nav-link px-0">Inicio <span class="sr-only">(current)</span>
					</a></li>
					<li class="nav-item g-mx-20--lg"><a href="#tienda"
						class="nav-link px-0">Tienda </a></li>
					<li class="nav-item g-mx-20--lg"><a href="#ofertas"
						class="nav-link px-0">Ofertas </a></li>
					<li class="nav-item g-ml-20--lg g-mr-0--lg"><a
						href="#registro" class="nav-link px-0">Registro </a></li>
				</ul>
			</div>
			<!-- End Navigation -->
		</div>
	...
	<!-- Section BANNER -->
	<section id="home"
		class="u-bg-overlay g-pos-rel g-theme-bg-blue-dark-v1-opacity-0_8--after">
	<div class="js-carousel" data-autoplay="true" data-infinite="true"
		...
		<div class="js-slide g-bg-img-hero g-height-100vh"
			style="background-image: url(assets/img/images.jpg);"></div>

		<div class="js-slide g-bg-img-hero g-height-100vh"
			style="background-image: url(assets/img/images2.jpg);"></div>
	</div>

	<div class="u-bg-overlay__inner g-absolute-centered w-100">
		<div class="container text-center g-max-width-750">
			<div
				class="text-uppercase u-heading-v2-4--bottom u-promo-title g-brd-primary">
				<h3
			...
			<div class="row justify-content-center">
				<div class="col-md-4 mx-auto g-py-15">
					<div class="media g-px-50--lg">
						...
						<div class="media-body">
							<span
								class="d-block g-color-white g-font-weight-500 g-font-size-17 text-uppercase">Entregas
				...
				<div
					...
					<div class="media g-px-50--lg">
						...
						<div class="media-body">
							<span
								class="d-block g-color-white g-font-weight-500 g-font-size-17 text-uppercase">Devoluciones
				...
				<div class="col-md-4 mx-auto g-py-15">
					<div class="media g-px-50--lg">
						...
						<div class="media-body text-left">
							<span
								class="d-block g-color-white g-font-weight-500 g-font-size-17 text-uppercase">24
	...
	<!-- TIendas -->
	<section id="tienda"> <!-- under --> <section>
	<div class="container">
		<div class="text-center g-mb-50">
			<h2 class="h2">Under Armour</h2>
			<div
				class="u-divider u-divider-db-dotted u-divider-center g-brd-gray-dark-v5 w-75 mx-auto g-my-80">
				<img
					class="u-divider__icon u-divider__icon--indented rounded-circle"
					src="assets/img/undermini.png" alt="">
			</div>
		</div>
							...
							<div class="g-pos-rel">
								...
								<div class="g-z-index-2 g-pos-abs g-top-15 g-right-15">
									<a
										...
										href="#!"> <i class="icon-medical-022 u-line-icon-pro"></i>
									</a>
								</div>
								<div
									class="u-block-hover__additional--fade g-flex-middle g-pa-15">
									<div class="g-flex-middle-item--bottom">
										<a
											class="d-inline-block g-bg-primary-opacity-0_8 g-bg-primary--hover g-color-white g-font-size-default g-text-underline--none--hover rounded g-py-5 g-px-10"
											href="#!"> <i
	...
	<div class="container">
		<div class="text-center g-mb-50">
			<h2 class="h2">Jordan air</h2>
			<div
				class="u-divider u-divider-db-dotted u-divider-center g-brd-gray-dark-v5 w-75 mx-auto g-my-80">
				<img
					class="u-divider__icon u-divider__icon--indented rounded-circle"
					src="assets/img/airjordanmini.png" alt="">
			</div>
		</div>
